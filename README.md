...
- Пополните баланс или оплатите заказ банковской картой, SberPay, МИР или кошельком ЮMoney
...
**BoosteRino** - интернет-магазин услуг продвижения и накрутки в соцсетях. Личный кабинет покупателя, админ-панель с наценкой и приём платежей: карта, SberPay, МИР или кошелёк ЮMoney.
...
| Оплата | Предоплата на баланс или оплата заказа картой, SberPay, МИР или кошельком ЮMoney |
...
5. В админке заполните: ключ поставщика, кошелёк для приёма платежей, SMTP, глобальную наценку
6. В настройках приёма платежей укажите URL HTTP-уведомлений:

```
https://boosterino.ru/api/v1/payments/yoomoney/notify
```

Секрет из кошелька - в поле «Секрет уведомлений» в админке. URL также отображается на вкладке «Настройки».
...
- Ключ поставщика, настройки приёма платежей, SMTP - в таблице `settings` в MySQL

(function () {
  ...
  async function loadOrders() {
    ...
    ordersEl.innerHTML = `
      <div class="table-wrap"><table>
        <thead><tr><th>#</th><th>Услуга</th><th>Кол-во</th><th>Сумма</th><th>Статус</th><th></th></tr></thead>
        <tbody>${orders.map((o) => `
          <tr>
            <td>${o.id}</td>
  ...
  async function loadTransactions() {
    ...
    txEl.innerHTML = `<div class="table-wrap"><table>
      <thead><tr><th>Дата</th><th>Тип</th><th>Сумма</th><th>Баланс</th></tr></thead>
      <tbody>${rows.map((t) => `
        <tr>
  ...
  function updatePrice() {
    ...
    if (!svc || !qty) { preview.textContent = '-'; return; }
